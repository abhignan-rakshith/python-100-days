...
# ------------CANVAS------------
canvas = tk.Canvas(width=200, height=250, bg=YELLOW, highlightthickness=0)
...
# calls pause_timer() when pressed
button_pause = tk.Button(text="Pause", command=pause_timer)
button_pause.config(bg="orange", highlightthickness=0)
